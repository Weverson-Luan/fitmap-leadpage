...
const features = [
  {
    ...
    description:
      "Personal trainers qualificados na sua região, prontos para te atender.",
  },
  {
    icon: Target,
    title: "Treinos Personalizados",
    description:
      "Planos de treino adaptados aos seus objetivos e necessidades.",
  },
  {
    icon: Calendar,
    title: "Flexibilidade de Horários",
    description:
      "Agende seus treinos nos horários que melhor se encaixam na sua rotina.",
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    description:
      "Acompanhamento profissional para alcançar suas metas mais rápido.",
  },
];
