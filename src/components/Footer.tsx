      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-white/5 hover:bg-green-500 rounded-full flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-white/60 hover:text-green-500 transition-colors">
                  Encontrar Personal
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-white/40 hover:text-green-500 transition-colors">
              Termos de Uso
            </a>
            <a href="#" className="text-white/40 hover:text-green-500 transition-colors">
              Privacidade
